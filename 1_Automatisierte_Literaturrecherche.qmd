...
Der entstandene Gemini Deep Research Text Output wurde in Googles AI Studio eingefügt und der folgende Prompt ausgeführt:

::: {.callout-note collapse="true"}
Verwendeter Prompt in Gemini Advanced (Deep Research mit 2.5 Pro)

Konvertiere sämtliche Referenzen in diesem Text in die passenden APA7 Zitate und füge ein passendes überarbeitetes Literaturverzeichnis am Ende ein. Gib den Text als formatierte Latex Datei aus. Den Rest des Textes niemals verändern.[Textinput der Datei Deep_Research_Gemini_Literatur_Performance_Effort_Output.docx]
:::

Das neu entstandene Dokument wurde erneut abgespeichert [📄 Deep_Research_Gemini_Output_APA7](Deep_Research_Gemini_Output_APA7.docx)
...
## Ganzen Überprüfungsprozess automatisieren z.B. KI Reviewer Prozess
...
## Evtl. alternative Recherche mit ChatGPT oder anderen Tools unter Berücksichtigung von passender Forschungsmethodik
