...
Nach dem mehrminütigen Bearbeiten der Aufgabe, wurden beide Reports exportiert und abgespeichert, einmal das Ergebnis von [📄 Deep_Research_ChatGPT_Output](static/Deep_Research_ChatGPT_Literatur_KI_Suche_Output.docx){.btn .btn-primary} sowie von Gemini 
[📄 Deep_Research_Gemini_Output](static/Deep_Research_Gemini_Literatur_Performance_Effort_Output.docx){.btn .btn-primary}. Augenscheinvalidität zeigte ein deutlich besseres Ergebnis für Gemini, weshalb dieser Report weiter bearbeitet wurde.

## Aufbereitung des Textes und Konvertierung der Referenzen in APA7

Der entstandene Gemini Deep Research Text Output wurde in Gemini AI Studio eingefügt und der folgende Prompt ausgeführt: 
