---
title: "Automatisierte Literaturrecherche anhand des Beispiels der Beziehung von Effort und Performance"
author: "Ramon Füglister"
---

## Aufgabe

Gibt es in der Forschungsliteratur einen Zusammenhang von Effort und Leistung (Performance) und wenn ja, wie ist dieser Zusammenhang beschaffen (linear, polyonmial etc.)? Der Schwerpunkt der Recherche bildet also der Zusammenhang der psychologischen Konstrukte kognitiver Effort und kognitive Leistung. Ein weiteres Ziel war es ausserdem die Literatursuche soweit zu möglich mit KI Tools zu unterstützen und automatisieren. Als Idee dient dazu das Paper von [Agent Laboratory](https://agentlaboratory.github.io/).

## Resultat

Der provisorische Report ist 👉 [📄 Hier](mein-dokument.docx){.btn .btn-primary}
 verfügbar.
...
Anschliessend wurden beide Reports exportiert und abgespeichert, einmal für (Deep_Research_ChatGPT_Output..pdf) (14.04.2025)
...
to be done (in Python mit API Google Gemini, evtl. Papers suchen)
