...
Der provisorische Report ist  [📄 Hier](mein-dokument.docx){.btn .btn-primary} verfügbar.
...
Diese Suchbegriffe, brachten viele interessante Papers zum Einsatz von "research workflow llm" mit Python etc. hervor, z.B. 
https://agentlaboratory.github.io/ etc.
...
Nach dem mehrminütigen Bearbeiten der Aufgabe, wurden beide Reports exportiert und abgespeichert, einmal das Ergebnis von [📄 Deep_Research_ChatGPT_Output](Deep_Research_ChatGPT_Literatur_KI_Suche_Output.docx){.btn .btn-primary} sowie von Gemini 
[📄 Deep_Research_Gemini_Output](Deep_Research_Gemini_Literatur_Performance_Effort_Output.docx){.btn .btn-primary}. Augenscheinvalidität zeigte ein deutlich besseres Ergebnis für Gemini, weshalb dieser Report weiter bearbeitet wurde.

## Aufbereitung des Textes und Konvertierung der Referenzen in APA7

Der entstandene ChatGPT Deep Research Text Output (Deep_Research_ChatGPT_Output_2) wurde in Gemini eingefügt und der folgende Prompt ausgeführt: 
...
Das neu entstandene Dokument wurde erneut abgespeichert [📄 Deep_Research_Gemini_Output_APA7](Deep_Research_Gemini_Output_APA7.docx){.btn .btn-primary}



## Ungültige Referenzen erkennen
to be done (mit  Python evtl. Link checken,  mit API Google Gemini Deep_Research_Gemini_Output_APA7 inhaltlich checken, evtl. weitere Papers suchen)
...
## Ganzen Überprüfungsporzess automatisieren z.B. KI Reviewer Prozess
